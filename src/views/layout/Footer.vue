          ...
          >
            ...
            <div class="social-icon">
              <svg class="icon" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fill-rule="evenodd"
                  d="M5 2H19A3 3 0 0 1 22 5V19A3 3 0 0 1 19 22H5A3 3 0 0 1 2 19V5A3 3 0 0 1 5 2ZM10 7 H14 V9 H11 V10.5 H13 V12 H11 V13.5 H14 V15 H10 Z
    "
                />
              </svg>
            </div>
          ...
          <a
            href="https://www.figma.com/design/TxrKTnLaReUg87NiaOzroc/One-toDay-%ED%99%94%EC%9D%B4%ED%8C%85-?node-id=0-1&t=YhoOoqDZoT4DSXjS-1"
            class="social-link group figma"
            target="_blank"
          >
            ...
            <div class="social-icon">
              ...
              >
                <path
                  ...
                  transform="translate(2 1) scale(1.5)"
                  fill="currentColor"
                ></path>
              </svg>
            </div>
...
/* 다크모드 컬러 */
.footer-container[data-theme='dark'] .tooltip {
  color: #d1d5db;
